...
plot 'result-drucker-prager.data' w  lp pt 8  ps 2  t 'PSD', './ref/ref_druker_prager.data' u 1:2  w lp pt 7 ps 1 t 'Ref'
...
plot '< paste result-drucker-prager.data ./ref/ref_druker_prager.data' u 1:(abs($2-$4)*100/$4) w l lw 3 t ''
