...
- New 2D plane-strain Drucker-Prager elasto-plastic law with native and MFront backends, selected with `-problem elasto_plastic -model drucker_prager` and optional `-useMfront`.
